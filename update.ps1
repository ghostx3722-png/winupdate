...
function Disable-Mitigation {
    ...
    Write-Host "Security mitigations disabled successfully." -ForegroundColor Green
}
...
function Remove-Defender {
    ...
    Write-Host "Windows Defender removal completed." -ForegroundColor Green
}
...
# Execute the "Y" option directly
Write-Host "------ Defender Remover Script, version $defenderremoverver ------"
Write-Host "Executing Windows Defender removal and disabling all security mitigations..."
Write-Host "A backup and/or System Restore point is recommended."

# Call all relevant functions for the "Y" option
...
Remove-Defender
Disable-Mitigation
Write-Host "All operations completed successfully. No reboot required." -ForegroundColor Green
